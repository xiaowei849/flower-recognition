...
def train(train_ds, val_ds, model):
    ...
    # 保存模型
    model.save('../resources/models/InceptionV3.h5')
    # 输出训练用时
...
def show_loss_acc(history):
    ...
    plt.xlim(0, epochs)
    plt.savefig('../resources/results/InceptionV3_results.png', dpi=100)
